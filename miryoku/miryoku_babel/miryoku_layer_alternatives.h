...
U_MT(LGUI, Y),     U_MT(LALT, I),     U_MT(LGUI, E),    U_MT(LSHFT, A),    &kp DOT,           &kp D,             U_MT(LSHFT, S),    U_MT(LCTRL, T),    U_MT(LALT, N),     U_MT(LGUI, B),     \
...
U_MT(LCTRL, A),         U_MT(LALT, O),     U_MT(LGUI, E),    U_MT(LSHFT, U),    &kp I,             &kp D,              U_MT(LSHFT, H),     U_MT(LCTRL, T),     U_MT(LALT, N),     U_MT(LGUI, S),     \
...
U_MT(LGUI, S),     U_MT(LALT, H),     U_MT(LCTRL, N),    U_MT(LSHFT, T),    &kp COMMA,         &kp DOT,           U_MT(LSHFT, A),    U_MT(LGUI, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
...
U_MT(LCTRL, A),     U_MT(LALT, S),     U_MT(LCTRL, H),    U_MT(LSHFT, T),    &kp G,             &kp Y,             U_MT(LSHFT, N),    U_MT(LGUI, E),    U_MT(LALT, O),     U_MT(LGUI, I),     \
...
U_MT(LCTRL, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
